...
class FL_GrpcStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UpdateGrad_Clipping = channel.unary_unary(
                '/FL_Grpc/UpdateGrad_Clipping',
                request_serializer=fl__grpc__pb2.GradRequest_Clipping.SerializeToString,
                response_deserializer=fl__grpc__pb2.GradResponse_Clipping.FromString,
                )
...
def add_FL_GrpcServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UpdateGrad_Clipping': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateGrad_Clipping,
                    request_deserializer=fl__grpc__pb2.GradRequest_Clipping.FromString,
                    response_serializer=fl__grpc__pb2.GradResponse_Clipping.SerializeToString,
            ),
    }
...
class FL_Grpc(object):
    ...
    def Update_SignSGD(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/FL_Grpc/Update_SignSGD',
            fl__grpc__pb2.signSGD_Request.SerializeToString,
            fl__grpc__pb2.signSGD_Response.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def UpdateGrad_Clipping(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/FL_Grpc/UpdateGrad_Clipping',
            fl__grpc__pb2.GradRequest_Clipping.SerializeToString,
            fl__grpc__pb2.GradResponse_Clipping.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
