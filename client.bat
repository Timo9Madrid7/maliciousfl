...
python clearAdaclipping_client.py --id 3 | ^
python clearAdaclipping_client.py --id 2 | ^
python clearAdaclipping_client.py --id 1 | ^
python clearAdaclipping_client.py --id 0